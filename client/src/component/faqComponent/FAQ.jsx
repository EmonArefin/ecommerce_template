...
import "../faqComponent/faq.css"


const FaqPage = () => {
  return (
    <section id="faq">
      <div className="faq-section-title my-5">
        <p className="text-center">FREQUENTLY ASKED QUESTIONS</p>
        <h3 className="text-center">Common Queries Answered</h3>
      ...
      <Accordion.Item eventKey="0">
        <Accordion.Header>How to review the product?</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header>Where you can order from.</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header>How to claim faulty product?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="3">
        <Accordion.Header>Which products are dangerous?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
